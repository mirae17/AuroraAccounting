...
<div class="container py-4">
    <div class="card shadow-lg">
        ...
        <div class="card-body">
            <form action="{{ route('purchaseOrder.store') }}" method="POST" id="purchaseOrder-form">
                @csrf

                <!-- Step 1: Customer & Purchase Order Details -->
                <div id="step-1">
                    <h4 class="text-primary">Step 1: Customer & Purchase Order Details</h4>
                    <div class="row">
                        <!-- Customer Details -->
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="customer-select">Select Customer:</label>
                                <select name="iPurchOrderCustDfk" id="customer-select" class="form-control" required
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="iPurchOrderNo" class="form-control" value="{{ $newpurchaseOrderNumber }}"
                                    readonly>
                            </div>
                            <div class="form-group">
                                <label>Purchase Order Date:</label>
                                <input type="date" name="dPurchOrderdate" class="form-control" value="{{ date('Y-m-d') }}"
                                    required>
                            </div>
                        </div>
                    </div>
                ...
                <!-- Step 2: Purchase Order Items -->
                <div id="step-2" style="display: none;">
                    <h4 class="text-primary">Step 2: Add Purchase Order Items</h4>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 text-end" name="yPurchOrderSubtotal">RM <span
                                        id="summary-subtotal">0.00</span></div>
                            </div>
                            <div class="row">
                                <div class="col-md-6"><strong>Tax (%):</strong></div>
                                <div class="col-md-6 text-end">
                                    <input type="number" id="iPurchOrderTax" name="iPurchOrderTax" class="form-control" min="0"
                            ...
                            <input type="hidden" name="yPurchOrderSubtotal" id="hidden-subtotal">
                            <input type="hidden" name="yPurchOrderTotalPayment" id="hidden-total-payment">
                        </div>
                    </div>
                    <div class="d-flex justify-content-between mt-3">
...
<script>
    ...
    function calculateFinalTotal() {
        ...
        const taxRate = parseFloat(document.getElementById('iPurchOrderTax').value) || 0;
        const discountRate = parseFloat(document.getElementById('iPurchOrderDiscount').value) || 0;
