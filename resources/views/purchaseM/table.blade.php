            ...
            <tbody>
                @foreach($purchaseM as $purchasesM)
                    <tr>
                        ...
                        <td>{{ $purchasesM->supplier->iSuppCode ?? 'N/A' }}-{{ $purchasesM->supplier->iSuppDesc ?? 'N/A' }}
                        </td>
                        ...
                        <td> <!-- Edit and Delete Icons -->
                            <a href="{{ route('purchaseM.edit', $purchasesM->ipmaspk) }}"
                                class="btn btn-custom-edit btn-sm">
                                <i class="fa fa-edit"></i>
                            </a>
                            <form action="{{ route('purchaseM.destroy', $purchasesM->ipmaspk) }}" method="POST"
