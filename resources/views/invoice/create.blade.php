    ...
    <div class="card shadow-lg">
        ...
        <div class="card-body">
            <form action="{{ route('invoice.store') }}" method="POST" id="invoice-form">
                ...
                <div id="step-1">
                    <h4 class="text-primary">Step 1: Customer & Invoice Details</h4>
                    <div class="row">
                        <!-- Customer Details -->
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="customer-select">Select Customer:</label>
                                <select name="iInvcCustDfk" id="customer-select" class="form-control" required
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="iInvcNo" class="form-control" value="{{ $newInvoiceNumber }}"
                                    readonly>
                            </div>
                            <div class="form-group">
                                <label>Invoice Date:</label>
                                <input type="date" name="dInvcdate" class="form-control" value="{{ date('Y-m-d') }}"
                                    required>
                            </div>
                        </div>
                    </div>
                ...
                <div id="step-2" style="display: none;">
                    <h4 class="text-primary">Step 2: Add Invoice Items</h4>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 text-end" name="yInvcSubtotal">RM <span
                                        id="summary-subtotal">0.00</span></div>
                            </div>
                            <div class="row">
                                <div class="col-md-6"><strong>Tax (%):</strong></div>
                                <div class="col-md-6 text-end">
                                    <input type="number" id="iInvcTax" name="iInvcTax" class="form-control" min="0"
...
<script>
    ...
    function calculateFinalTotal() {
        ...
        const taxRate = parseFloat(document.getElementById('iInvcTax').value) || 0;
        const discountRate = parseFloat(document.getElementById('iInvcDiscount').value) || 0;
