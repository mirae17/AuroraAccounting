...
<body>
    ...
    <div class="col-lg-6 d-flex">
        ...
        <a href="{{ route('customerDetail.create') }}" class="btn btn-success rounded-pill shadow-sm px-4 mr-2">
            <i class="fas fa-plus-circle"></i> Add Customer Details
        </a>
        <a href="{{ route('customerDetail.pdf') }}" class="btn btn-info rounded-pill shadow-sm px-4 ">
                ...
                @foreach($customerDetail as $customer)
                    ...
                    <tr>
                        ...
                        <td> <!-- Edit and Delete Icons -->
                            ...
                            <form action="{{ route('customerDetail.destroy', $customer->iCustDPk) }}" method="POST"
