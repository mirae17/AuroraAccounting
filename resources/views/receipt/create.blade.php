...
<div class="container py-4">
    <div class="card shadow-lg">
        ...
        <div class="card-body">
            <form action="{{ route('receipt.store') }}" method="POST" id="receipt-form">
                @csrf

                <!-- Step 1: Customer & Receipt Details -->
                <div id="step-1">
                    <h4 class="text-primary">Step 1: Customer & Receipt Details</h4>
                    <div class="row">
                        <!-- Customer Details -->
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="customer-select">Select Customer:</label>
                                <select name="iRecptCustDfk" id="customer-select" class="form-control" required
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="iRecptNo" class="form-control" value="{{ $newReceiptNumber }}"
                                    readonly>
                            </div>
                            <div class="form-group">
                                <label>Receipt Date:</label>
                                <input type="date" name="dRecptdate" class="form-control" value="{{ date('Y-m-d') }}"
                                    required>
                            </div>
                        </div>
                    </div>
                ...
                <div id="step-2" style="display: none;">
                    <h4 class="text-primary">Step 2: Add Receipt Items</h4>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 text-end" name="yRecptSubtotal">RM <span
                                        id="summary-subtotal">0.00</span></div>
                            </div>
                            <div class="row">
                                <div class="col-md-6"><strong>Tax (%):</strong></div>
                                <div class="col-md-6 text-end">
                                    <input type="number" id="iRecptTax" name="iRecptTax" class="form-control" min="0"
                            ...
                            <input type="hidden" name="yRecptSubtotal" id="hidden-subtotal">
                            <input type="hidden" name="yRecptTotalPayment" id="hidden-total-payment">
                        </div>
                    </div>
                    <div class="d-flex justify-content-between mt-3">
...
<script>
    ...
    function calculateFinalTotal() {
        ...
        const taxRate = parseFloat(document.getElementById('iRecptTax').value) || 0;
        const discountRate = parseFloat(document.getElementById('iRecptDiscount').value) || 0;
