        ...
        <div class="text-center mb-4">
            <form action="{{ route('receipt.store') }}" method="POST">
                ...
                @if(isset($companyMaintenance))
                    ...
                    <!-- Pass the Company ID -->
                    <input type="hidden" name="iRecptComfk" value="{{ $companyMaintenance->company->id }}">
                @else
                    @if(Auth::user()->role === 'system admin')
                        <!-- System Admin: Allow company selection -->
                        <div class="form-group">
                            <label for="iRecptComfk">Select Company:</label>
                            <select name="iRecptComfk" id="iRecptComfk" class="form-control">
                    ...
                    @else
                        ...
                        <input type="hidden" name="iRecptComfk" value="{{ Auth::user()->company_id }}">
                    @endif
                @endif
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <select name="iRecptCustDfk" id="customer-select" class="form-control"
            ...
            <!-- Right: Recpttation Details -->
            <div class="col-md-6 text-end">
                <h5>Receipt Details</h5>
                <div class="form-group">
                    <label for="iRecptNo">Receipt No:</label>
                    <input type="text" name="iRecptNo" id="iRecptNo" class="form-control"
                        value="{{ $newReceiptNumber }}" readonly>
                </div>
                <div class="form-group">
                    <label for="dRecptdate">Date:</label>
                    <input type="date" name="dRecptdate" id="dRecptdate" class="form-control"
            ...
            <table class="table table-bordered">
                ...
                <tfoot>
                    <tr>
                        ...
                        <input type="hidden" name="yRecptSubtotal" id="hidden-subtotal" value="0">
                    </tr>
                </tfoot>
            </table>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group mb-3">
                    ...
                    <input type="number" id="discount" name="iRecptDiscount" class="form-control"
                        oninput="calculateTotal()" placeholder="Enter Discount">
                </div>
                <div class="form-group mb-3">
                    <label for="tax" class="form-label">Tax (%):</label>
                    <input type="number" id="additional-tax" name="iRecptTax" class="form-control"
                        oninput="calculateTotal()" placeholder="Enter Tax">
                </div>
                <div class="form-group mb-3">
                    <label for="shipping" class="form-label">Shipping:</label>
                    <input type="number" id="shipping" name="iRecptShipping" class="form-control"
                ...
                <div class="row mt-3">
                    <div class="col-md-12 text-end">
                        ...
                        <input type="hidden" name="yRecptTotalPayment" id="hidden-total-amount" value="0.00">
                    </div>
                </div>
            </div>
        </div>
