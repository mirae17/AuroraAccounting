<script>
    ...
    function addItem() {
        ...
        <td>
            ...
            <input type="text" name="items[${itemIndex}][cQuoItemProductCode]" class="form-control item-code" readonly>
        </td>
        <td>
        
            <input type="text" name="items[${itemIndex}][cQuoItemDescription]" class="form-control item-description" readonly>
        </td>
        <td>
